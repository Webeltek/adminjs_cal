...
import { withRegister } from "./authentication/register.handler.js";
...
export const buildAuthenticatedRouter = (
  ...
  const gmailCallbackPath = '/admin/login/gmail_cb';
  withLogin(router, admin,loginPath,gmailCallbackPath, auth);
