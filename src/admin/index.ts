...
import {
  ...
  CreateNfRoomResource,
  CreateNfUserResource,
  CreateNfPaymentResource
...
export const generateAdminJSConfig: () => AdminJSOptions = () => ({
  ...
  locale,
  assets: {
    styles: ['/custom.css', '/react-big-calendar.css'],
